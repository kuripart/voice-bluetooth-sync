...
public class ArmConnectivityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arm_connectivity);

        //Calling widgets
        btnPaired = (Button)findViewById(R.id.button_arm);
        deviceList = (ListView)findViewById(R.id.listViewArm);
