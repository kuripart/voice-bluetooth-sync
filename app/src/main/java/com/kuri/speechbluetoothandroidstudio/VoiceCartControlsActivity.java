...
public class VoiceCartControlsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voice_cart_controls);
        ...
        voiceLayerInput = (TextInputLayout) findViewById(R.id.voice_input_layout_cart);
        micButton = (ImageButton) findViewById(R.id.mic_button_2_cart);
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void> {  // UI thread
        ...
        {
            progress = ProgressDialog.show(VoiceCartControlsActivity.this, "Connecting.......", "Please wait!");  //show a progress dialog
        }
